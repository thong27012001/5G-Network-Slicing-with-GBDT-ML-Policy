...
Baseline-p75 relative thresholds: URLLC=0.066ms, eMBB=11.682ms, mMTC=0.297ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.95, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.067/0.062ms, eMBB=13.130/11.938ms, mMTC=0.309/0.316ms.
