...
Baseline-p75 relative thresholds: URLLC=0.070ms, eMBB=24.936ms, mMTC=0.419ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.90, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.073/0.065ms, eMBB=28.750/26.881ms, mMTC=0.444/0.452ms.
