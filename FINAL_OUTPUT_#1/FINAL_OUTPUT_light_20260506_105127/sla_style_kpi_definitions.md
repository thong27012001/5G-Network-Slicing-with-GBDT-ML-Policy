...
Baseline-p75 relative thresholds: URLLC=0.065ms, eMBB=11.998ms, mMTC=0.298ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.95, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.066/0.061ms, eMBB=13.475/12.258ms, mMTC=0.310/0.319ms.
