...
Baseline-p75 relative thresholds: URLLC=0.069ms, eMBB=24.872ms, mMTC=0.429ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.90, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.072/0.065ms, eMBB=28.747/27.114ms, mMTC=0.456/0.464ms.
