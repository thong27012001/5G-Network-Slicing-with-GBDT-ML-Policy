...
Baseline-p75 relative thresholds: URLLC=0.066ms, eMBB=11.675ms, mMTC=0.306ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.95, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.067/0.061ms, eMBB=13.134/12.160ms, mMTC=0.322/0.329ms.
