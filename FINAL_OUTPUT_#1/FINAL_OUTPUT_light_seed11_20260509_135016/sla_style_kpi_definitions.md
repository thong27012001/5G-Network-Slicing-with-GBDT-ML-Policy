...
Baseline-p75 relative thresholds: URLLC=0.066ms, eMBB=11.604ms, mMTC=0.300ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.95, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.067/0.061ms, eMBB=13.095/11.750ms, mMTC=0.316/0.323ms.
