...
Baseline-p75 relative thresholds: URLLC=0.070ms, eMBB=24.791ms, mMTC=0.424ms.
Completion-ratio hit thresholds: URLLC>=0.95, eMBB>=0.90, mMTC>=0.95.
Per-slice p95 (BL/ML, ms): URLLC=0.072/0.065ms, eMBB=28.781/26.902ms, mMTC=0.449/0.458ms.
